...
enum ErrorCode
{
    ...
    SELF_TEST_CHASSIS_START_FAILED = 0x05020003,
    ...
    SLAM_REV_IMU_LOSS_LOT = 0x1222007B,
    SLAM_REV_ODM_LOSS_LOT = 0x1222008F,
    SLAM_REV_LASER_LOSS_LOT = 0x122200A3,

    SLAM_LACK_MEMORY = 12230051,
    SLAM_LACK_CPU = 12230052,

    SLAM_CALIB_PARAM_READ_FAILED = 0x12220001,
    SLAM_ODM_PARAM_READ_FAILED = 0x12220002,
    SLAM_RUN_PARAM_READ_FAILED = 0x12220003,
...
//TOF
    ...
    TOF_DEVNUM_FAULT = 0x14110053,
        
//Chassis
    CHASSIS_NOT_MOUNT = 0x02110015,
    CHASSIS_START_FAULT = 0x02110016,
    CHASSIS_REPLACE_UNREGISTERED_FAULT= 0x02110017,
    //CLIFF
...
//MULTIMODULE
    ...
    MULTIMODULE_DEVNUM_FAULT = 0x0C110053,
...
//HOTSPOT
    ...
    MULTIMODULE_SYSTEM_OVER_TEMPERATURE_ALARM = 0x17210065,   // 系统温度过高报警
...
/******************MARKER-ERROR-CODE*****************/
MARKER_INIT_FAILTURE,
MARKER_START_FAILTURE,
MARKER_PAUSE_FAILTURE,
MARKER_STOP_FAILTURE,
//RETURN STATE
MARKER_STATE_EXCEPTION_GET_IMAGE,
MARKER_STATE_EXCEPTION_CAMERA_PARAMS,
MARKER_STATE_EXCEPTION_GET_TAG_ID,
MARKER_STATE_EXCEPTION_UNKNOWN,
MARKER_STATE_EXCEPTION_IR_STAE,
MARKER_STATE_SUCCESS_GET_TAG_ID_ONLY,
MARKER_STATE_SUCCESS_GET_TAG_POSE,
MARKER_NO_ERROR,
// image exception
MARKER_ERR_IMG_IS_EMPTY,
MARKER_ERR_IMG_NOT_GRARY,
// tag id exception
MARKER_ERR_TAG_NO_ID_DETECTED,
MARKER_ERR_TAG_MORE_THAN_ONE_ID_DETECTED,
MARKER_ERR_TAG_MATCH_NOT_UNIQ,
// get tag id only, reference frame: vehicle
MARKER_ERR_TAG_ONLY_ID_DETECTED,
MARKER_ERR_TAG_IS_NOT_PLANE,
MARKER_ERR_TAG_NOT_WORKSPACE_TOO_FAR,
MARKER_ERR_TAG_NOT_WORKSPACE_TOO_CLOSE,
MARKER_ERR_TAG_NOT_WORKSPACE_OUT_OF_DEGREE_RANGE,
MARKER_ERR_TAG_NOT_WORKSPACE_OUT_OF_DEGREE_RANGE_LEFT, // positive
MARKER_ERR_TAG_NOT_WORKSPACE_OUT_OF_DEGREE_RANGE_RIGHT, // negative
MARKER_ERR_TAG_WORKSPACE_TILT, 
MARKER_ERR_TAG_WORKSPACE_TILT_LEFT, // negative
MARKER_ERR_TAG_WORKSPACE_TILT_RIGHT, // positive
MARKER_ERR_TAG_WORKSPACE_PITCH,
MARKER_ERR_TAG_WORKSPACE_PITCH_UP, // negative
MARKER_ERR_TAG_WORKSPACE_PITCH_DOWN, // positive
MARKER_ERR_TAG_WORKSPACE_SIDE_WAY, 
MARKER_ERR_TAG_WORKSPACE_SIDE_LEFT, // negative
MARKER_ERR_TAG_WORKSPACE_SIDE_RIGHT, // positive
MARKER_ERR_TAG_WORKSPACE_FLIP,
/****************************************************/
